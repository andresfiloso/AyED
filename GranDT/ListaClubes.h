...
/******************************************************************************/
/* Definiciones de Tipos de DatoCs */
/*--------------------------------*/

/* tipo enumerado para realizar comparaciones */
enum ResultadoComparacionC {
  MAYOR_C,
  IGUAL_C,
  MENOR_C
};
/* Tipo de Informacion que esta contenida en los Nodos de la
   ListaC, identificada como DatoC. */
typedef Club DatoC;

/* Tipo de Estructura de los Nodos de la ListaC. */
struct NodoListaC {
    DatoC dato; // dato almacenado
    NodoListaC* sgte; // puntero al siguiente
};

/* Tipo de Puntero a los Nodos de la ListaC, el cual se usa para recorrer
   la ListaC y acceder a sus DatoCs. */
typedef NodoListaC* PtrNodoListaC;


/* Tipo de Estructura de la ListaC */
struct ListaC{
    PtrNodoListaC primero;      // puntero al primer nodo de la lista
};

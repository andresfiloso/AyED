...
/******************************************************************************/
/* Definiciones de Tipos de DatoJs */
/*--------------------------------*/

/* tipo enumerado para realizar comparaciones */
enum ResultadoComparacionJ {
  MAYOR,
  IGUAL,
  MENOR
};
/* Tipo de Informacion que esta contenida en los Nodos de la
   ListaJ, identificada como DatoJ. */
typedef Jugador DatoJ;

/* Tipo de Estructura de los Nodos de la ListaJ. */
struct NodoListaJ {
    DatoJ dato; // dato almacenado
    NodoListaJ* sgte; // puntero al siguiente
};

/* Tipo de Puntero a los Nodos de la ListaJ, el cual se usa para recorrer
   la ListaJ y acceder a sus DatoJs. */
typedef NodoListaJ* PtrNodoListaJ;


/* Tipo de Estructura de la ListaJ */
struct ListaJ{
    PtrNodoListaJ primero;      // puntero al primer nodo de la lista
};
...
/*----------------------------------------------------------------------------*/
/*
  pre : lista Jreada con crearLista().
